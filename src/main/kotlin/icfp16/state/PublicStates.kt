...
class PublicStates {
  ...
  companion object {
    val localState: Array<IState> = arrayOf(
        ...
        ).setName("problem 8, 567, 569, 583, 773, 1094, 1558, 1606, 1610, 1705, 1778, 1779, 1780, 1781, 1782, 1783, 1784, 2421, 2424, 2425, 2426, 2427, 2531, 2670, 2780, 2802"),
        ...
        ).setName("Cool last phigure")
    )

    val states: Array<IState> = localState
      .plus(PaulPublicStates.states)
      .plus(DimaPublicStates.states)
      .plus(NastyaPublicStates.states)
  }
